...
class Cluster(object):
    ...
    def maxLinkageDist(self, other):
        ...
        for i in self.points:
            for j in other.points:
                if i.distance(j)>maxdist:
                    maxdist=i.distance(j)
        return maxdist
    def averageLinkageDist(self, other):
        ...
        for i in self.points:
            for j in other.points:
                    avg+=i.distance(j)
        return avg/(len(self.points)*len(other.points))            
    def members(self):
...
class ClusterSet(object):
    ...
    def mergeClusters(self, c1, c2):
        ...
        # TO DO
        cnew=Cluster(list(set(c1.points)|set(c2.points)),c1.pointType)
